...
def predict():
    ...
    if output==1:
        return render_template('forestfire.html',pred='Your Forest is in Danger.\nProbability of fire occuring is {}'.format(output),bhai="LAGNA SAKXA HOSIYAR")
    else:
        return render_template('forestfire.html',pred='Your Forest is safe.\n Probability of fire occuring is {}'.format(output),bhai="Your Forest is Safe CHINTA NAGARA")
